...
export default function TodoList({ listType, title, tasks }: TodoListProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={`flex-1 border backdrop-blur-sm ${accentColors[listType]} flex max-h-[88vh] min-h-0 flex-col overflow-hidden rounded-xl pb-8 transition-all duration-200 ${
